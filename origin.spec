...
%{!?commit:
%global commit e7fe38ca1114525053cff05fd018b4731a183f66
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_COMMIT=e7fe38ca11 OS_GIT_VERSION=v3.7.0-alpha.1+e7fe38c-369 OS_GIT_MAJOR=3 OS_GIT_MINOR=7+ OS_GIT_TREE_STATE=clean
}
