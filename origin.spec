...
%{!?commit:
%global commit d536e7b51a023039fc4c906d3312e2e0f3ecd26b
}
%global shortcommit %(c=%{commit}; echo ${c:0:7})
# os_git_vars needed to run hack scripts during rpm builds
%{!?os_git_vars:
%global os_git_vars OS_GIT_COMMIT=d536e7b51a OS_GIT_VERSION=v3.7.0-alpha.1+d536e7b-370 OS_GIT_MAJOR=3 OS_GIT_MINOR=7+ OS_GIT_TREE_STATE=clean
}
